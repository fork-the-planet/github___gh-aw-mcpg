...
- `MCP_GATEWAY_URL_DOMAIN_AUDIT` - Enable URL-domain audit logging (sets default for `--url-domain-audit`). When enabled, observed domains are written to `observed-url-domains.json`. Default: `false`
